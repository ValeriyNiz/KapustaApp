...
export const getTotalIncome=state=>state.report.totalReportObject.income.totalSum
export const getTotalExpenses=state=>state.report.totalReportObject.expenses.totalSum